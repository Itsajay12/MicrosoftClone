...
const Body = () => {
  return (
    <>
      ...
      <div>
              {/* banner */}
        <div className="bg-blue-500 text-white w-auto h-20  flex items-center justify-center">
          <p className="font-semibold hover:underline w-3/4 md:w-auto sm:text-justify">
            Require assistance with Microsoft 365? Call 0008004402127 to inquire
            or make a purchase.
          </p>
